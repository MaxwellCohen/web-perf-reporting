...
import type { InsightsContextItem } from '@/components/page-speed/pageSpeedInsightsTypes';
...
export type { InsightsContextItem } from '@/components/page-speed/pageSpeedInsightsTypes';
