...
vi.mock('@/components/page-speed/javascript-metrics/javascriptMetricsSelectors', async (importOriginal) => {
  const { selectJavaScriptMetrics } =
    (await importOriginal()) as typeof import('@/components/page-speed/javascript-metrics/javascriptMetricsSelectors');
  return {
...
vi.mock('@/components/page-speed/network-metrics/NetworkRequestsSummaryCard', () => ({
...
vi.mock('@/components/page-speed/network-metrics/TimingMetricsCard', () => ({
  TimingMetricsCard: ({ metrics }: { metrics: Array<{ ttfb: number }> }) => (
    <div>Timing metrics: {metrics.map((metric) => metric.ttfb).join(',')}</div>
  ),
}));

vi.mock('@/components/page-speed/network-metrics/TimelineCard', () => ({
...
vi.mock('@/components/page-speed/network-metrics/LCPBreakdownCard', () => ({
  LCPBreakdownCard: ({ metrics }: { metrics: unknown[] }) => (
    <div>LCP breakdown count: {metrics.length}</div>
  ),
}));

vi.mock('@/components/page-speed/network-metrics/NetworkRTTCard', () => ({
...
vi.mock('@/components/page-speed/network-metrics/ServerLatencyCard', () => ({
...
vi.mock('@/components/page-speed/network-metrics/ResourceTypeBreakdownCard', () => ({
...
vi.mock('@/components/page-speed/network-metrics/TopResourcesCard', () => ({
  TopResourcesCard: ({
    stats,
  }: {
...
vi.mock('@/components/page-speed/javascript-metrics/JavaScriptSummaryCard', () => ({
...
vi.mock('@/components/page-speed/javascript-metrics/TaskSummaryCard', () => ({
  TaskSummaryCard: ({
    metrics,
  }: {
...
vi.mock('@/components/page-speed/javascript-metrics/BootupTimeCard', () => ({
...
vi.mock('@/components/page-speed/javascript-metrics/MainThreadWorkCard', () => ({
  MainThreadWorkCard: ({
    metrics,
  }: {
...
vi.mock('@/components/page-speed/javascript-metrics/UnusedJavaScriptCard', () => ({
...
vi.mock('@/components/page-speed/javascript-metrics/UnminifiedJavaScriptCard', () => ({
...
vi.mock('@/components/page-speed/javascript-metrics/LegacyJavaScriptCard', () => ({
...
vi.mock('@/components/page-speed/javascript-metrics/extractJSMetrics', () => ({
  extractJSMetrics: (item: unknown) => extractJSMetricsMock(item),
}));

vi.mock('@/components/page-speed/RecommendationsSection/analyzeAudits', () => ({
...
vi.mock('@/components/page-speed/RecommendationsSection/FilterControls', () => ({
  FilterControls: ({
    filteredCount,
    totalCount,
    expandedCount,
...
vi.mock('@/components/page-speed/RecommendationsSection/RecommendationItem', () => ({
...
import { RecommendationsSection } from '@/components/page-speed/RecommendationsSection/RecommendationsSection';
import {
  ScoreDisplay,
  ScoreDisplayModes,
  isEmptyResult,
  sortByScoreDisplayModes,
} from '@/components/page-speed/ScoreDisplay';
