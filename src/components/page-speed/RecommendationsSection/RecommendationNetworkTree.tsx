...
import { formatBytes } from '@/components/page-speed/RecommendationsSection/utils';
...
import { isNetworkDependencyTreeRecommendation } from '@/components/page-speed/RecommendationsSection/recommendationHelpers';
