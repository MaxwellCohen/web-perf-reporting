...
vi.mock('@/components/page-speed/RecommendationsSection/IssuesFoundTableCell', () => ({
  IssuesFoundTableCell: ({ value }: { value: unknown }) => <span>{String(value)}</span>,
}));

vi.mock('@/components/page-speed/lh-categories/table/NetworkWaterfallCell', () => ({
  NetworkWaterfallCell: () => <span data-testid="waterfall" />,
}));

vi.mock('@/components/page-speed/shared/useSimpleTable', () => ({
