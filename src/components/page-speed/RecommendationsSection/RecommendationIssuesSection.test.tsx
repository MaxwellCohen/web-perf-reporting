...
vi.mock('@/components/page-speed/RecommendationsSection/IssuesFoundTable', () => ({
  IssuesFoundTable: ({
    headings,
    items,
    device,
...
vi.mock('@/components/page-speed/auditTableConfig', () => ({
...
describe('RecommendationIssuesSection', () => {
  ...
  it('renders separate tables per report when itemsByReport', async () => {
    const { shouldShowSeparateTablesPerReport } = await import(
      '@/components/page-speed/auditTableConfig'
    );
