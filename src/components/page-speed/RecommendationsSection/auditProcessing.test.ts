...
describe('auditProcessing', () => {
  ...
  describe('getWorstScore', () => {
    ...
    it('returns null when all scores are null', () => {
      const entries = [
        { auditId: 'a', audit: { score: null }, label: 'M', item: {} },
      ];
  ...
  describe('combineMetricSavings', () => {
    it('returns empty object when no metricSavings', () => {
      const entries = [
        { audit: { metricSavings: undefined }, label: 'M', auditId: 'a', item: {} },
      ];
        ...
        items: [
          {
            ...
            headings: [{ key: 'url', label: 'URL' }, { key: 'wastedBytes', label: 'Wasted' }],
          },
        ],
      };
