...
vi.mock('@/components/page-speed/RecommendationsSection/RecommendationHeader', () => ({
  RecommendationHeader: ({ recommendation }: { recommendation: { title: string } }) => (
    <span>{recommendation.title}</span>
  ),
}));

vi.mock('@/components/page-speed/RecommendationsSection/ActionableStepsTable', () => ({
  ActionableStepsTable: () => <div data-testid="actionable-steps" />,
}));

vi.mock('@/components/page-speed/RecommendationsSection/ResourcesTable', () => ({
  ResourcesTable: () => <div data-testid="resources-table" />,
}));

vi.mock('@/components/page-speed/RecommendationsSection/RecommendationNetworkTree', () => ({
  RecommendationNetworkTree: () => <div data-testid="network-tree" />,
}));

vi.mock('@/components/page-speed/RecommendationsSection/RecommendationAuditDetails', () => ({
  RecommendationAuditDetails: () => <div data-testid="audit-details" />,
}));

vi.mock('@/components/page-speed/RecommendationsSection/RecommendationIssuesSection', () => ({
