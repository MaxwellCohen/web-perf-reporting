...
describe("Card", () => {
  it("renders all card sections with their expected content", () => {
    ...
    expect(screen.getByText("Performance Report")).toHaveClass("tracking-tight");
    expect(screen.getByText("Summary for the latest run")).toHaveClass("text-muted-foreground");
