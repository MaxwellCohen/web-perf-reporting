...
const DropdownMenuSubContent = radixClassForward(
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(checkableMenuItemStyles, className)}
    checked={checked}
    {...props}
  >
...
const DropdownMenuSeparator = radixClassForward(DropdownMenuPrimitive.Separator, separatorStyles);
