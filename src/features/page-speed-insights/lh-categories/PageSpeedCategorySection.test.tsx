...
import { PageSpeedCategorySection } from "@/features/page-speed-insights/lh-categories/PageSpeedCategorySection";

vi.mock("@/features/page-speed-insights/lh-categories/CategoryAuditSection", () => ({
...
describe("PageSpeedCategorySection", () => {
  it("renders nothing when data has no categories", () => {
    const data = [{ lighthouseResult: { categories: null, audits: {} } }];
