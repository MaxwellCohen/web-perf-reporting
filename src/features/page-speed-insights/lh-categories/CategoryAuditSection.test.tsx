...
vi.mock("@/features/page-speed-insights/lh-categories/CategoryScoreInfo", () => ({
...
vi.mock("@/features/page-speed-insights/lh-categories/AuditDetailsSection", () => ({
...
describe("CategoryAuditSection", () => {
  ...
  it("renders category title and score info", () => {
    const category = [
      {
        title: "Performance",
        auditRefs: [{ id: "first-contentful-paint", group: undefined }],
      },
    ];
    const auditsRecords = [
      {
