...
export function LHCategoryTitleCell(
  props: CellContext<TableDataItem, string>,
) {
  const category = props.getValue();
  return <div className="basis-48 text-xl font-bold">{category}</div>;
}

export function LHCategoryScoreCell(
  props: CellContext<TableDataItem, string | string[]>,
) {
...
export function LHAuditDescriptionCell(
  props: CellContext<TableDataItem, unknown>,
) {
