...
import { ScreenshotComponent } from "@/features/page-speed-insights/ScreenshotComponent";
...
describe("ScreenshotComponent", () => {
  ...
  it('shows "Image unavailable" when screenshot.data is empty', () => {
    const { container } = render(
      <ScreenshotComponent screenshot={{ data: "", width: 100, height: 80 }} />,
    );
  ...
  it("renders image when screenshot has valid data", () => {
    ...
    const { container } = render(<ScreenshotComponent screenshot={screenshot} />);
